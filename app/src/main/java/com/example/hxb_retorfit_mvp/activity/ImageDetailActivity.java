...
import com.example.hxb_retorfit_mvp.adapter.ImageDetailAdapter;
...
import com.example.hxb_retorfit_mvp.mvp.presenter.ImageDetailPresenterImpl;
...
import com.example.hxb_retorfit_mvp.utils.CompetenceUtils;
...
public class ImageDetailActivity extends BaseActivity
    ...
    public void switchShare() {
        ActivityUtils.share(this, TextUtils.concat(ApiUrl.IMAGER_URL, list.get(viewPager.getCurrentItem()).getSrc()));
    }
}
